...
const displayPokemonDetails = (pokemon) => {
  ...
  const captalizePokemonName = captalizeFirstLetter(name);
  document.querySelector("title").textContent = captalizePokemonName;

  const detailMainElement = document.querySelector(".detail-main");
  detailMainElement.classList.add(name.toLowerCase());

  document.querySelector(".name-wrap .name").textContent = captalizePokemonName;
